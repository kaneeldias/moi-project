export default function ProjectBoxSkeleton() {
    ...
    return (
        <div className={`flex flex-row h-fit w-full md:w-fit animate-pulse`}>
            <div className={"flex flex-row bg-white rounded-md shadow-md text-gray-800 h-24 md:min-w-[400px] w-full md:w-fit"}>
                ...
                <div className={`flex flex-col pl-5 space-y-1 justify-center`}>
                    <div>
                        ...
                        <div className={"h-2 bg-gray-400 rounded-full dark:bg-gray-700 w-32 mb-4"}></div>
                    </div>
                    <div className={"h-2.5 bg-gray-400 rounded-full dark:bg-gray-700 w-32 mb-4"}></div>
                </div>
            </div>
        </div>
    );
